...
<!-- The plans directory defaults to `plans/` relative to the project root.
     The agent harness may override this path. -->

All plans are written to `plans/` with this naming convention:
...
```
plans/fix-0123-null-pointer-in-user-lookup.md
plans/feature-0456-add-retry-with-backoff.md
plans/refactor-simplify-error-propagation.md
```
